...
from yarppg.rppg.roi.roi_detect import (CaffeDNNFaceDetector, FaceMeshDetector, FaceMeshDetector2,
...
def get_processor(args):
    ...
    if name == "licvpr":
        ...
        return ChromProcessor(winsize=args.winsize, method="XsminaYs")
